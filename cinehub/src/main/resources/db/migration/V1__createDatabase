...
CREATE TABLE IF NOT EXISTS "Media_Genere" (
  "media_id" uuid,
  "genere_id" varchar,
...
CREATE TABLE IF NOT EXISTS "Moderato" (
  "moderatore_id" varchar,
  "moderato_id" varchar,
  "tipo" varchar,
  PRIMARY KEY ("moderatore_id", "moderato_id")
);
...
ALTER TABLE "Moderato" ADD FOREIGN KEY ("moderato_id") REFERENCES "Utente" ("email");
